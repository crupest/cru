#include "cru/graphics/direct2d/ImageFactory.h"
...
#include "cru/graphics/direct2d/Image.h"
...
std::unique_ptr<IImage> WinImageFactory::DecodeFromStream(Stream* stream) {
...
void WinImageFactory::EncodeToStream(IImage* image, Stream* stream,
