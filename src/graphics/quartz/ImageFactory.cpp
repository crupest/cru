...
#include "cru/graphics/quartz/Image.h"
#include "cru/Check.h"
...
void QuartzImageFactory::EncodeToStream(IImage* image, Stream* stream,
  ...
  auto uti = ::cru::osx::ToCF(GetImageFormatUniformTypeIdentifier(format));
