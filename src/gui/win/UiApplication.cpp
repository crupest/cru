...
#include "cru/gui/win/Clipboard.h"
#include "cru/gui/win/Cursor.h"
#include "cru/gui/win/Exception.h"
#include "cru/gui/win/GodWindow.h"
#include "cru/gui/win/InputMethod.h"
#include "cru/gui/win/Window.h"
...
WinUiApplication::WinUiApplication() {
  ...
  graph_factory_ = std::make_unique<
      cru::graphics::direct2d::DirectGraphicsFactory>();
