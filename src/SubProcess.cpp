...
#include <cru/Unix.h>
namespace {
using ThisPlatformSubProcessImpl = cru::PosixSpawnSubProcessImpl;
}
#endif
...
Stream* PlatformSubProcess::GetStdinStream() {
  return this->state_->impl->GetStdinStream();
}

Stream* PlatformSubProcess::GetStdoutStream() {
  return this->state_->impl->GetStdoutStream();
}

Stream* PlatformSubProcess::GetStderrStream() {
...
Stream* SubProcess::GetStdinStream() {
  CheckValid();
  return platform_process_->GetStdinStream();
}

Stream* SubProcess::GetStdoutStream() {
  CheckValid();
  return platform_process_->GetStdoutStream();
}

Stream* SubProcess::GetStderrStream() {
  CheckValid();
