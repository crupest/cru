...
// Current: CRU_GRAPHICS_API
// Removed: CRU_PLATFORM_GRAPHICS_API

#ifdef CRU_PLATFORM_WINDOWS
#ifdef CRU_GRAPHICS_EXPORT_API
#define CRU_GRAPHICS_API __declspec(dllexport)
#else
#define CRU_GRAPHICS_API __declspec(dllimport)
#endif
#else
#define CRU_GRAPHICS_API
#endif
#define CRU_PLATFORM_API CRU_GRAPHICS_API
#define CRU_PLATFORM_GRAPHICS_API CRU_GRAPHICS_API
